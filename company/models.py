...
class Company(models.Model):
	"""
	Company's general information: We should have named this "customer". 
	company model represent the customer of our user(Export advisor/consultant)
...
class RequestedLead(models.Model):
	"""When we provide leads to the company"""
	company = models.ForeignKey(Company, related_name='requestedleads')
