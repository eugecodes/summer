...
class BestMarketsPDFReport(LoginRequiredMixin, PDFTemplateView):
	"""The New flashier PDF report with all the countries"""
	template_name = "newmarkets/best_markets_pdf.html"
